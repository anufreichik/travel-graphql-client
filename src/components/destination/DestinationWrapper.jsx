        ...
        <div>
            {destinationId && (
                <>
                    ...
                    {/*>*/}
                    {/*    <Button onClick={() => toggleDialog('Activity')} startIcon={<AddIcon/>} >*/}
                    {/*        Activity*/}
                    {/*    </Button>*/}
                    {/*    <Button onClick={() => toggleDialog('Food')} startIcon={<AddIcon/>}>*/}
                    {/*        Food Place*/}
                    {/*    </Button>*/}
                    {/*    <Button onClick={() => toggleDialog('Accommodation')} startIcon={<AddIcon/>}>*/}
                    {/*        Accommodation*/}
                    {/*    </Button>*/}
                    {/*</Stack>*/}
